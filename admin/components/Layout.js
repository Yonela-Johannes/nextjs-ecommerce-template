  ...
  if(!session) {
    return (
      <div className="md:bg-[#254441] min-h-screen bg-tertiary">
        <Image className="object-contain hidden md:block mx-auto md:h-[40px] md:w-[40px] p-1 w-[22px] h-[22px]" src={logo} alt='logo' />
        <div className="block md:hidden mb-4 w-full items-center justify-between px-1 py-1">
          ...
          <div className="flex flex-col text-text_primary p-2 rounded-lg">
            <Image className="object-contain flex mx-auto md:h-[35px] md:w-[35px] p-1 w-[22px] h-[22px]" src={logo} alt='logo' />
          </div>
        </div>
